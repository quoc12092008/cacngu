...
local function DoFarmerJob(job)
	...
	if WalkToPosition(targetPos + Vector3.new(0, 2, 0)) then
		...
		-- ⏱️ DELAY KHI ĐẾN PET (tăng delay để ổn định)
		statusText.Text = "Status : Arrived at " .. job.pet_name .. ", waiting..."
		task.wait(2)  -- Đứng chờ thêm khi đến pet
...
print("✅ Script loaded with Server Mode and Camera Adjustment!")
