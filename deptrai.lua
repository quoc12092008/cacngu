    ...
    function mmb() 
        ...
        function SetText(Name, Text)
            ...
            elseif Name == "Currencies" then
                -- Parse currency text (có HTML tags)
                ...
                if level then
                    statsLabels.Level.Text = "Level: " .. level
                end
                if beli then
                    statsLabels.Beli.Text = "Beli: " .. beli
                end
                if frag then
                    statsLabels.Frag.Text = "Frag: " .. frag
                end
            elseif Name == "Melees" then
                -- Có thể bỏ qua hoặc hiển thị ở đâu đó
            elseif Name == "LiveTime" then
                -- Có thể bỏ qua hoặc hiển thị
            elseif Name == "DebugLine" then
                -- Debug info - có thể bỏ qua
            end
        end
