...
local function isPetClaimed(petName)
	local success, res = pcall(function()
		return request({ Url = SERVER_URL .. "/check?pet_name=" .. petName, Method = "GET" })
	end)
...
-- ✅ ĐỊNH NGHĨA GetPetsInPlot() TRƯỚC
