...
_G["Fumo Blox Fruit - HoHo Hub Kaitun V3"] = {
    ...
    AutoBuy = {
        ...
        All_Haki = false, --true/false ken,buso,geppo,soru we will buy this in first
        Legendary_Swords = true, -- true/false buy all leg sword
        Ectoplasm_Items = false, -- true/false buy all ecto items
    },
    AutoItems = {
        ["Second Sea"] = {"Kabucha","Rengoku"},
        ["Third Sea"] = {"Cursed Dual Katana","Soul Guitar","Tushita","Yama","AutoElite","AutoRipIndra"},
    ...
    HopServerFarm = false, -- true/false why not?
