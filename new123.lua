(function() 
    ...
    function mmb()
        local Orders = {"MainTextLabel", "Task1", "Task2", "Currencies", "Melees", "DebugLine"}
        ...
        -- Tạo các label theo Orders
        local spacing = 25
        for i, name in ipairs(Orders) do
            Interface.Instances[name] = createLabel(name, 35 + (i - 1) * spacing)
        end
